...
export function ProfilePageContent({ username }: { username: string }) {
  ...
  return (
    <div className="space-y-5 pb-20">
      ...
      {/* Loading */}
      {isLoading && (
        <div className="space-y-4" aria-busy="true" aria-label="Loading profile data">
      ...
      {/* Error */}
      {!isLoading && error && (
        <div role="alert" className="rounded-lg border border-red-500/30 bg-red-500/5 p-6 text-center space-y-2">
