...
export const ImplementationCoverageSchema = z.strictObject({
  ...
  detectors: z.array(z.strictObject({ kind: ImplementationKindSchema, version: z.enum(["1.0.0", "1.0.1", "1.0.2", "1.0.3", "1.0.4", "1.0.5"]),
  ...
  .refine(v => v.bundle.id === "tsjs_implementation" && /^1\.0\.[012345](?:-q[01]{16})?$/.test(v.bundle.version)
